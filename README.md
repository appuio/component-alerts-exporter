# Commodore Component: alerts-exporter

This is a [Commodore][commodore] Component for alerts-exporter.
...
The rendered documentation for this component is available on the [Commodore Components Hub](https://hub.syn.tools/alerts-exporter).
